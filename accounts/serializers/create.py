...
class HealthInfoSerializer(serializers.ModelSerializer):
    """Serializer for HealthInfo model"""
    ...
    class Meta:
        ...
        read_only_fields = ["record_date", "updated_at"]
...
class CareGiversSerializer(serializers.ModelSerializer):
    """Serializer for CareGivers model"""
